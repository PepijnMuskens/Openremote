...
public abstract class AnomalyDetectionConfiguration implements Serializable {
    ...
    public AnomalyDetectionConfiguration(@JsonProperty("onOff") Boolean onOff, @JsonProperty("deviation") Integer deviation, @JsonProperty("timespan") ForecastConfigurationWeightedExponentialAverage.ExtendedPeriodAndDuration timespan){
        this.onOff = onOff;
    ...
    public static class Global extends AnomalyDetectionConfiguration {
        ...
        @JsonCreator
        public Global(@JsonProperty("onOff") Boolean onOff, @JsonProperty("deviation") Integer deviation, @JsonProperty("timespan") ForecastConfigurationWeightedExponentialAverage.ExtendedPeriodAndDuration timespan) {
            super(onOff, deviation, timespan);
        }
    ...
    public static class Change extends AnomalyDetectionConfiguration {
        ...
        @JsonCreator
        public Change(@JsonProperty("onOff") Boolean onOff, @JsonProperty("deviation") Integer deviation, @JsonProperty("timespan") ForecastConfigurationWeightedExponentialAverage.ExtendedPeriodAndDuration timespan) {
            super(onOff, deviation,timespan);
        }
    }
}
