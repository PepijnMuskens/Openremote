...
public final class MetaItemType {
     ...
     */
    public static final MetaItemDescriptor<AnomalyDetectionConfiguration[]> ANOMALYDETECTION = new MetaItemDescriptor<>("anomalyDetection", ValueType.ANOMALY_DETECTION_CONFIGURATION.asArray());
