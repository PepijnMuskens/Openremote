...
public final class ValueType {
    ...
    public static final ValueDescriptor<AnomalyDetectionConfiguration> ANOMALY_DETECTION_CONFIGURATION = new ValueDescriptor<>("anomalyDetectionConfiguration", AnomalyDetectionConfiguration.class);
